...
class skipuser extends StatefulWidget {
  const skipuser({Key? key}) : super(key: key);

  @override
  State<skipuser> createState() => _skipuserState();
}

class _skipuserState extends State<skipuser> {
  @override
                              ...
                              children: [
                                ...
                                Container(alignment: Alignment.center,
                                    ...
                                    child: Padding(
                                      ...
                                      child:                             InkWell(
                                          onTap: () {
                                            Navigator.push(context, MaterialPageRoute(builder:  (context) =>docupload(),));
                                          },
                                          child: Text("Check Now",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white70),)),
                                    )),
