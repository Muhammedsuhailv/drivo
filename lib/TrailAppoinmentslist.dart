...
class trailall extends StatefulWidget {
  const trailall({Key? key}) : super(key: key);

  @override
  State<trailall> createState() => _trailallState();
}

class _trailallState extends State<trailall> {
  @override
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              ...
                              Padding(
                                ...
                                child: Icon(Icons.contact_support_outlined,color: Colors.white70,),
                              ),
                        ...
                        InkWell(onTap: (){ Navigator.push(context, MaterialPageRoute(builder: (context)=>sessions()));},
                          child: Padding(
                            ...
                            child: Container(alignment: Alignment.center,
                                ...
                                child: Text("Pending Trail",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),)),
                          ),
                        ),
                        ...
                        InkWell(onTap: (){ Navigator.push(context, MaterialPageRoute(builder: (context)=>sessions()));},
                          child: Padding(
                            ...
                            child: Container(alignment: Alignment.center,
                                ...
                                child: Text("Finished Trail",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white),)),
                          ),
                        ),
