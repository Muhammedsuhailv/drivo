    ...
    return DefaultTabController(
      ...
      child: Scaffold(
          ...
          child: FloatingActionButton(backgroundColor: Colors.deepPurple,foregroundColor: Colors.white,shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(50)),onPressed: () {
            showDialog(context: context, builder: (context){
              return AlertDialog( backgroundColor:Colors.black,
                title: Column(
                  children: [
                    Text("APPLY FOR TRAIL",style: TextStyle(fontSize: 18,color: Colors.white70,fontWeight: FontWeight.w500),),
                    SizedBox(height: 10,),
        ...
        appBar: AppBar(
          ...
          ,title: Text('Trail Appoinments',style: TextStyle(color: Colors.white70,fontSize: 18,fontWeight: FontWeight.w500),),
